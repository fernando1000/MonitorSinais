/**
 * Get_vehicle_fence_route_list.java
 *
...
/**
 *  Get_vehicle_fence_route_list bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Get_vehicle_fence_route_list implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = get_vehicle_fence_route_list
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":get_vehicle_fence_route_list", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "get_vehicle_fence_route_list", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Get_vehicle_fence_route_list parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Get_vehicle_fence_route_list object = new Get_vehicle_fence_route_list();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"get_vehicle_fence_route_list".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Get_vehicle_fence_route_list) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
