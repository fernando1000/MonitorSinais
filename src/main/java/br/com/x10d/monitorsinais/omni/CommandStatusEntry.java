...
public class CommandStatusEntry implements org.apache.axis2.databinding.ADBBean {
  
    protected java.util.Calendar localSeqId;
    ...
    public java.util.Calendar getSeqId() {
        return localSeqId;
    }
     ...
     * @param param SeqId
     */
    public void setSeqId(java.util.Calendar param) {
        localSeqIdTracker = param != null;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":commandStatusEntry", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
         ...
         */
        public static CommandStatusEntry parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CommandStatusEntry object = new CommandStatusEntry();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"commandStatusEntry".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CommandStatusEntry) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setSeqId(org.apache.axis2.databinding.utils.ConverterUtil.convertToDateTime(
                            content));
