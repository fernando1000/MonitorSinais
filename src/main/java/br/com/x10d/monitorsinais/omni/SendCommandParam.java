...
/**
 *  SendCommandParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SendCommandParam implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = sendCommandParam
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":sendCommandParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "sendCommandParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SendCommandParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SendCommandParam object = new SendCommandParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"sendCommandParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SendCommandParam) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
