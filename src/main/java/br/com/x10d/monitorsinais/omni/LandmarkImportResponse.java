...
/**
 *  LandmarkImportResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class LandmarkImportResponse extends br.com.x10d.monitorsinais.omni.ApiResponse
    implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = landmarkImportResponse
     ...
     * field for Errors
     */
    protected br.com.x10d.monitorsinais.omni.Errors_type0 localErrors;
     ...
     * @return br.com.zatix.portalorion.linkerapi.Errors_type0
     */
    public br.com.x10d.monitorsinais.omni.Errors_type0 getErrors() {
        return localErrors;
    }
     ...
     * @param param Errors
     */
    public void setErrors(br.com.x10d.monitorsinais.omni.Errors_type0 param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":landmarkImportResponse", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "landmarkImportResponse", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static LandmarkImportResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            LandmarkImportResponse object = new LandmarkImportResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"landmarkImportResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (LandmarkImportResponse) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "errors").equals(
                            reader.getName())) {
                    object.setErrors(br.com.x10d.monitorsinais.omni.Errors_type0.Factory.parse(
                            reader));
