...
/**
 *  LandmarkCoordinates bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class LandmarkCoordinates implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":landmarkCoordinates", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "landmarkCoordinates", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static LandmarkCoordinates parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            LandmarkCoordinates object = new LandmarkCoordinates();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"landmarkCoordinates".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (LandmarkCoordinates) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
