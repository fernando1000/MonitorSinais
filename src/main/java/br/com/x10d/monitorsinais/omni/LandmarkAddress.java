...
/**
 *  LandmarkAddress bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class LandmarkAddress implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Dist
     */
    protected java.lang.String localDist;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localDistTracker = false;
    ...
    public boolean isDistSpecified() {
        return localDistTracker;
    }
     ...
     * @param param Dist
     */
    public void setDist(java.lang.String param) {
        localDistTracker = param != null;

        this.localDist = param;
    }
    ...
    public void setNum(int param) {
        ...
        localNumTracker = param != java.lang.Integer.MIN_VALUE;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":landmarkAddress", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "landmarkAddress", xmlWriter);
            }
        }
        ...
        if (localDistTracker) {
            namespace = "";
            writeStartElement(null, namespace, "dist", xmlWriter);
            ...
            if (localDist == null) {
                ...
                xmlWriter.writeCharacters(localDist);
            }
    ...
    public static class Factory {
         ...
         */
        public static LandmarkAddress parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            LandmarkAddress object = new LandmarkAddress();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"landmarkAddress".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (LandmarkAddress) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "dist").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "dist" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setDist(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "num" + "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setNum(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
                ...
                if (reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "str" + "  cannot be null");
                    }
