...
/**
 *  Send_command bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Send_command implements org.apache.axis2.databinding.ADBBean {
     ...
     * field for Params
     */
    protected br.com.x10d.monitorsinais.omni.SendCommandParameters localParams;
    ...
    /**
     * Auto generated getter method
     * @return br.com.zatix.portalorion.linkerapi.SendCommandParameters
     */
    public br.com.x10d.monitorsinais.omni.SendCommandParameters getParams() {
        return localParams;
    }
    ...
    public void setParams(
        br.com.x10d.monitorsinais.omni.SendCommandParameters param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":send_command", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "send_command", xmlWriter);
            }
        }
        ...
        if (localParamsTracker) {
            ...
            localParams.serialize(new javax.xml.namespace.QName("", "params"),
                xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static Send_command parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Send_command object = new Send_command();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"send_command".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Send_command) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "mnemonic").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "mnemonic" + "  cannot be null");
                    }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "params").equals(
                            reader.getName())) {
                    object.setParams(br.com.x10d.monitorsinais.omni.SendCommandParameters.Factory.parse(
                            reader));
