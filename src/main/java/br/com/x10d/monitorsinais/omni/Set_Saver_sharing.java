...
/**
 *  Set_Saver_sharing bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Set_Saver_sharing implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = set_Saver_sharing
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":set_Saver_sharing", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "set_Saver_sharing", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Set_Saver_sharing parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Set_Saver_sharing object = new Set_Saver_sharing();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"set_Saver_sharing".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Set_Saver_sharing) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
