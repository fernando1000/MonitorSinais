...
public class Sequences implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * validate the array for SeqId
     */
    protected void validateSeqId(long[] param) {
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":sequences", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "sequences", xmlWriter);
        ...
        if (localSeqIdTracker) {
            if (localSeqId != null) {
                ...
                for (int i = 0; i < localSeqId.length; i++) {
                    if (localSeqId[i] != java.lang.Long.MIN_VALUE) {
                ...
                // write null attribute
                writeStartElement(null, "", "seqId", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static Sequences parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"sequences".equals(type)) {
                            ...
                            return (Sequences) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    while (!loopDone1) {
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName("", "seqId").equals(
                                        reader.getName())) {
                                nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                                        "nil");
                    ...
                    object.setSeqId((long[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            long.class, list1));
