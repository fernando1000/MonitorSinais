...
@Entity(name="sent_command")
public class SentCommand extends br.com.x10d.monitorsinais.omni.ApiResponse implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setToken(long param) {
        // setting primitive attribute tracker to true
        localTokenTracker = param != java.lang.Long.MIN_VALUE;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":sentCommand", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "sentCommand", xmlWriter);
        }
        ...
        if (localTokenTracker) {
            ...
            if (localToken == java.lang.Long.MIN_VALUE) {
                throw new org.apache.axis2.databinding.ADBException(
    ...
    public static class Factory {
         ...
         */
        public static SentCommand parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            SentCommand object = new SentCommand();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"sentCommand".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SentCommand) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setToken(org.apache.axis2.databinding.utils.ConverterUtil.convertToLong(
                            content));
                    ...
                    object.setToken(java.lang.Long.MIN_VALUE);
                }
