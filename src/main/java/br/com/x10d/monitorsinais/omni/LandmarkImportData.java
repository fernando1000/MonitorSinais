...
/**
 *  LandmarkImportData bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class LandmarkImportData implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = landmarkImportData
     ...
     * field for Addr
     */
    protected br.com.x10d.monitorsinais.omni.LandmarkAddress localAddr;
     ...
     * field for Coords
     */
    protected br.com.x10d.monitorsinais.omni.LandmarkCoordinates localCoords;
     ...
     * @return br.com.zatix.portalorion.linkerapi.LandmarkAddress
     */
    public br.com.x10d.monitorsinais.omni.LandmarkAddress getAddr() {
        return localAddr;
    }
     ...
     */
    public void setAddr(
        br.com.x10d.monitorsinais.omni.LandmarkAddress param) {
    ...
    /**
     * Auto generated getter method
     * @return br.com.zatix.portalorion.linkerapi.LandmarkCoordinates
     */
    public br.com.x10d.monitorsinais.omni.LandmarkCoordinates getCoords() {
        return localCoords;
    }
    ...
    public void setCoords(
        br.com.x10d.monitorsinais.omni.LandmarkCoordinates param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":landmarkImportData", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "landmarkImportData", xmlWriter);
            }
        }
        ...
        if (localAddrTracker) {
            ...
            localAddr.serialize(new javax.xml.namespace.QName("", "addr"),
                xmlWriter);
        }
        ...
        if (localCoordsTracker) {
            ...
            localCoords.serialize(new javax.xml.namespace.QName("", "coords"),
                xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static LandmarkImportData parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            LandmarkImportData object = new LandmarkImportData();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"landmarkImportData".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (LandmarkImportData) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "addr").equals(
                            reader.getName())) {
                    object.setAddr(br.com.x10d.monitorsinais.omni.LandmarkAddress.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "coords").equals(
                            reader.getName())) {
                    object.setCoords(br.com.x10d.monitorsinais.omni.LandmarkCoordinates.Factory.parse(
                            reader));
