...
/**
 *  LandmarkImportError bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class LandmarkImportError implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = landmarkImportError
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":landmarkImportError", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "landmarkImportError", xmlWriter);
            }
        }
        ...
        if (localLandmarkTracker) {
            ...
            localLandmark.serialize(new javax.xml.namespace.QName("", "landmark"),
                xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static LandmarkImportError parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            LandmarkImportError object = new LandmarkImportError();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"landmarkImportError".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (LandmarkImportError) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "landmark").equals(
                            reader.getName())) {
                    object.setLandmark(br.com.x10d.monitorsinais.omni.LandmarkImportData.Factory.parse(
                            reader));
