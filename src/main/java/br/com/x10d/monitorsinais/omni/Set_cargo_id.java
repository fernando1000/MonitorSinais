...
/**
 *  Set_cargo_id bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class Set_cargo_id implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":set_cargo_id", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "set_cargo_id", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Set_cargo_id parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            Set_cargo_id object = new Set_cargo_id();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"set_cargo_id".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Set_cargo_id) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
