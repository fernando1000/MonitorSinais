...
/**
 *  ApplicationException bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ApplicationException implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ApplicationException", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ApplicationException", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ApplicationException parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ApplicationException object = new ApplicationException();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ApplicationException".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ApplicationException) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
