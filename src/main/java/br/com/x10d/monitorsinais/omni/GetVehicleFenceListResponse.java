/**
 * GetVehicleFenceListResponse.java
 *
...
/**
 *  GetVehicleFenceListResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetVehicleFenceListResponse extends br.com.x10d.monitorsinais.omni.ApiResponse
    implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = getVehicleFenceListResponse
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":getVehicleFenceListResponse",
                xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "getVehicleFenceListResponse", xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static GetVehicleFenceListResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GetVehicleFenceListResponse object = new GetVehicleFenceListResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getVehicleFenceListResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GetVehicleFenceListResponse) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
