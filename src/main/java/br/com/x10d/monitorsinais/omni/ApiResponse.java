...
public class ApiResponse implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setStatusCode(int param) {
        ...
        localStatusCodeTracker = param != java.lang.Integer.MIN_VALUE;
    ...
    public static class Factory {
         ...
         */
        public static ApiResponse parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"apiResponse".equals(type)) {
                            ...
                            return (ApiResponse) br.com.x10d.monitorsinais.omni.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
